...
class MDDatePicker(BaseDialogPicker):
    ...
    def set_selected_widget(self, widget):
        ...
        if remove_from_list:
            self.selected_days_list.remove(self._current_selected_date)
        else:
            self.selected_days_list.append(self._current_selected_date)
...
<TimeInput>
    ...
    TimeInputTextField:
        ...
        num_type: "hour"
        pos: 0, 0
        hint_text_color_normal: root.text_color
...
class AmPmSelector( MDBoxLayout, ThemableBehavior, EventDispatcher):
...
class TimeInputTextField(MDTextField):
    ...
    def __init__(self, **kwargs):
        ...
        self.bind(foreground_color=self.setter("hint_text_color_normal"))
